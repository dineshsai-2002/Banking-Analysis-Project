...
📘 Project Overview:
----------------------
This project is a complete Banking Analytics System that integrates
MySQL + Python + Pandas + Matplotlib + Seaborn
to analyze customer, loan, and transaction data.
It automates:
Data Cleaning using Pandas
Data Storage using MySQL
Analytical Processing using Stored Procedures
Visualization using Python Dashboards
The dashboard provides 12 major insights related to customer behavior, loan performance, and transaction activity.
...
Create age groups, month columns, etc.
...
Matplotlib
Seaborn
Provides interactive menu-based dashboards for:
Customer Analytics
Loan Analytics
Transaction Analytics
Combined Banking Analytics

🧹 Tech Stack:
--------------
LayerToolsData CleaningPandasDatabaseMySQLLogicStored ProceduresVisualizationMatplotlib, SeabornBackendPython
📂 Project Structure
📁 Banking-Analytics-Dashboard
│── README.md
│── customers.csv
...
│── banking_dashboard_customers.py
│── banking_dashboard_loans.py
│── banking_dashboard_transactions.py
│── banking_dashboard_combined.py
...
Loan Performance (Closed vs Defaulted)
...
----------------------
Customer Analytics
python banking_dashboard_customers.py
...
Transaction Analytics:
----------------------
python banking_dashboard_transactions.py
Combined Analytics
python banking_dashboard_combined.py
...
Faster reporting with stored procedures
...
🧭 Future Improvements:
------------------------
Predictive ML models (loan default, churn)
